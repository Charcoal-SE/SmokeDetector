...
def test_bisect():
    ...
    # Test resulting in finding the \\L<city> issue; Shows which sub-group of watch/blacklist regexes causes the problem.
    ...
    # bisect_result = chatcommands.bisect(None, original_msg=msg)
    # print('bisect_result:', bisect_result)
    # expected_result = r"{!r} is not caught by a blacklist or watchlist item.".format(test_text)
    # print('expected_result:', expected_result)
    # assert bisect_result == expected_result
    # assert bisect_result == ""
