...
def test_parse_room_config():
    ...
    assert chatcommunicate._privileges[("stackexchange.com", 11540)] == set((1, 16070))
    ...
    assert chatcommunicate._privileges[("meta.stackexchange.com", 89)] == set((42,))
    assert chatcommunicate._privileges[("stackoverflow.com", 111347)] == set((1337, 256, 4766556))
    ...
    assert chatcommunicate._room_roles["no-all-caps title"] == set([("meta.stackexchange.com", 89)])
