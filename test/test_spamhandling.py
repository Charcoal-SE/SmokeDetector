...
class TestRoomReports(TestCase):
    ...
    def mock_post(
        ...
        if increment_auto_post_id:
            cls.auto_post_id += 1
            link = "https://stackoverflow.com/{}/{}".format(
                "q" if is_question else "a", cls.auto_post_id
            )
    ...
    def setUpClass(cls):
        ...
        GlobalVars.deletion_watcher = MagicMock(
            spec=GlobalVars.deletion_watcher, wraps=None
        )  # Mock the deletion watcher in test
        chatcommunicate.tell_rooms = MagicMock(
            spec=cls.orig_tell_rooms, wraps=None, side_effect=print_mock_args
        )  # Mock the tell_rooms, so we can test how it was called
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("", "", "bagprada", "", True),
        (
            "12 Month Loans quick @ https://www.quick12monthpaydayloans.co.uk/Elimination of collateral pledging",
            "",
            "",
            "",
            True,
        ...
        (
            "Not a phone number 192.168.0.1",
            "Not a phone number 192.168.0.1",
            "",
            "",
            False,
        ...
        (
            ...
            "<p>This this this this this this this this</p>",
            "",
        ...
        (
            "Raw link at end",
            """<p>This this this this this this this this <a href="https://example.net/harmless/">https://example.org/pesky-reviews-and-scam</a></p>""",
            "",
        ...
        (
            ...
            '<p><a href="https://example.com/bad-reviews-canada/" rel="nofollow noreferrer">Cliquez ici</a></p>',
            "",
            "",
            True,
        ),
        (
            ...
            '<p><a href="https://example.net/harmless/">https://example.org/pesky-reviews-and-scam</a></p>',
            "",
            "",
            True,
        ),
        (
            ...
            """<p>Don't trigger on link to <a href="https://askubuntu.com/questions-about-reviews">this StackExchange member site</a></p>""",
            "",
            "",
            False,
        ),
        (
            "FP test for bad URL pattern",
            """<p>Don't trigger on link to <a href="https://mathoverflow.net/questions-about-reviews">this StackExchange member site</a></p>""",
            "",
            "",
            False,
        ),
        ...
        (
            "Pattern Matching product name - 2 words",
            """<p>vxl male enhancement</p>""",
            "",
            "",
            True,
        ),
        (
            "Pattern Matching product name - 3 words",
            """<p>Extends Monster Male Enhancement And Male Penile Enhancement</p>""",
            "",
            "",
            True,
        ),
        (
            "A Title",
            """<p>E x t e n d s  M o n s t e r Male E n h a n c e m e n t And M a l e P e n i l e E n h a n c e m e n t</p>""",
            "",
