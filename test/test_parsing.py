...
@pytest.mark.parametrize(
    "input_data, parse_method, expected",
    [
        (
            "Testing * escaping of ] special [ characters",
            escape_markdown,
            r"Testing \* escaping of \] special \[ characters",
        ),
        ("HTML &#39; unescaping&lt;", unescape_title, "HTML ' unescaping<"),
        (
            "https://physics.stackexchange.com/users/7433/manishearth",
            get_user_from_url,
            ("7433", "physics.stackexchange.com"),
        ),
        (
            "https://softwarerecs.stackexchange.com/users/46/undo",
            get_user_from_url,
            ("46", "softwarerecs.stackexchange.com"),
        ),
        (
            "https://earthscience.stackexchange.com/users/20/hichris123",
            get_user_from_url,
            ("20", "earthscience.stackexchange.com"),
        ),
        (
            "https://codegolf.stackexchange.com/users/9275/programfox",
            get_user_from_url,
            ("9275", "codegolf.stackexchange.com"),
        ),
        (
        ...
        (
            "https://mathoverflow.net/users/66/ben-webster",
            get_user_from_url,
            ("66", "mathoverflow.net"),
        ),
        (
            "http://codegolf.stackexchange.com/u/9275",
            get_user_from_url,
            ("9275", "codegolf.stackexchange.com"),
        ),
        (
            "https://codegolf.stackexchange.com/u/9275/",
            get_user_from_url,
            ("9275", "codegolf.stackexchange.com"),
        ),
        (
            "http://codegolf.stackexchange.com/users/9275",
            get_user_from_url,
            ("9275", "codegolf.stackexchange.com"),
        ),
        (
            "https://codegolf.stackexchange.com/users/9275/",
            get_user_from_url,
            ("9275", "codegolf.stackexchange.com"),
        ),
        (
            "//stackoverflow.com/users/1/jeff-atwood",
            get_user_from_url,
            ("1", "stackoverflow.com"),
        ),
        ...
        (
            "https://stackoverflow.com/users/0/test",
        ...
        (
            "1234 stackoverflow.com",
            get_user_from_list_command,
            ("1234", "stackoverflow.com"),
        ),
        (
            "4321 communitybuilding.stackexchange.com",
            get_user_from_list_command,
            ("4321", "communitybuilding.stackexchange.com"),
        ),
        ("1 stackoverflow", get_user_from_list_command, ("1", "stackoverflow.com")),
        (
            "https://stackoverflow.com/questions/1/title-here",
            url_to_shortlink,
            "https://stackoverflow.com/questions/1",
        ),
        (
            "https://stackoverflow.com/questions/1/title-here/2#2",
            url_to_shortlink,
            "https://stackoverflow.com/a/2",
        ),
        (
            "https://writers.stackexchange.com/questions/1/%2f%2f",
            url_to_shortlink,
            "https://writers.stackexchange.com/questions/1",
        ),
        (
            "http://writers.stackexchange.com/questions/1/%2f%2f/2#2",
            url_to_shortlink,
            "https://writers.stackexchange.com/a/2",
        ),
        (
        ...
        (
            "http://stackoverflow.com/users/1234/abcd",
            user_url_to_shortlink,
            "https://stackoverflow.com/users/1234",
        ),
        ...
        (
            "https://stackoverflow.com/questions/123456/hello-world#654321",
            fetch_post_id_and_site_from_url,
            ("654321", "stackoverflow.com", "answer"),
        ),
        ...
        (
            ...
            ("246651", "meta.stackexchange.com", "question"),
        ),
        (
            test_data_inputs[0],
            fetch_owner_url_from_msg_content,
            "https://meta.stackexchange.com/users/279263/lisa-usher",
        ),
        (
            test_data_inputs[0],
        ...
        (
            ...
            "https://stackoverflow.com/questions/0/test-test",
        ),
        (
            test_data_inputs[1],
            fetch_post_id_and_site_from_msg_content,
            ("0", "stackoverflow.com", "question"),
        ),
        (
            test_data_inputs[1],
            fetch_owner_url_from_msg_content,
            "https://stackoverflow.com/users/0/test-test",
        ),
        ...
        (
            test_data_inputs[2],
            fetch_post_id_and_site_from_msg_content,
            ("42", "stackoverflow.com", "answer"),
        ),
        (
            test_data_inputs[2],
            fetch_owner_url_from_msg_content,
            "http://stackoverflow.com/users/0/test-test",
        ),
        (
            test_data_inputs[3],
            fetch_post_id_and_site_from_msg_content,
            ("27954020", "stackoverflow.com", "question"),
        ),
        (
            test_data_inputs[3],
            fetch_owner_url_from_msg_content,
            "https://stackoverflow.com/users/3754535/user3754535",
        ),
        (
            test_data_inputs[3],
            fetch_title_from_msg_content,
            "Why I can't insert data in a model from a custom controller?",
        ),
        (
            test_data_inputs[4],
            fetch_post_id_and_site_from_msg_content,
        ...
        (
            test_data_inputs[10],
            fetch_owner_url_from_msg_content,
            "//stackoverflow.com/users/3754535/user3754535",
        ),
        (
            test_data_inputs[10],
            fetch_title_from_msg_content,
        ...
        (
            test_data_inputs[12],
            fetch_post_id_and_site_from_msg_content,
            ("458053", "ru.stackoverflow.com", "question"),
        ),
        (
            test_data_inputs[12],
            fetch_owner_url_from_msg_content,
            "//ru.stackoverflow.com/users/20555/ni55an",
        ),
        (
            test_data_inputs[12],
            fetch_title_from_msg_content,
        ...
        (
            ...
            "[ [SmokeDetector](https://github.com/Charcoal-SE/SmokeDetector) ] Manually reported question (batch report: post 2 out of 3): *(gone)* by [user3754535](//stackoverflow.com/users/3754535/user3754535) on `stackoverflow.com`",
        ),
        (
            test_data_inputs[16],
            fetch_post_id_and_site_from_msg_content,
            ("230329", "drupal.stackexchange.com", "question"),
        ),
        (test_data_inputs[16], fetch_title_from_msg_content, "spammy spammy title"),
        (
            test_data_inputs[16],
            fetch_owner_url_from_msg_content,
            "//drupal.stackexchange.com/u/73447",
        ),
    ],
)
...
def test_post_parse_errors():
    ...
    try:
        failure = Post()
        assert (
            "Post with no initializer did not fail."
            == "An exception should have been generated and caught."
        )
