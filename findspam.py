...
class FindSpam:
    bad_keywords = ["baba ?ji", "fifa.{0,20}coins?", "fifabay", "Long Path Tool",
                    ...
                    "in (?:bangalore|chennai|delhi|hyderabad|kolkata|mumbai|madurai|coimbatore|rajkot|durgapur|surat|agra)</a>",
                    ...
                    "bring back lost lover", "service proposal essay"]
    ...
    blacklisted_websites = ["online ?kelas", "careyourhealths", "wowtoes", "(naga|dewa)poker",
                            ...
                            "hotxt\\.co\\.uk", "rcframecontractors"]
