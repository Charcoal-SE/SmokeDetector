...
create_rule("potentially bad keyword in {}", r"(?is)(?:^|\b|(?w:\b))keto(?:nes?)?(?:\b|(?w:\b)|$)",
            ...
            username=True, body_summary=True,
            max_rep=30, max_score=1)
# Watch (?-i:SEO|seo)$, but exempt Webmasters for titles, but not usernames. Was a watch added by iBug on 1541730383. (part 1)
create_rule("potentially bad keyword in {}", r"(?is)(?:^|\b|(?w:\b))(?-i:SEO|seo)$",
            ...
            max_rep=30, max_score=1)
# Watch (?-i:SEO|seo)$, but exempt Webmasters for titles, but not usernames. Was a watch added by iBug on 1541730383. (part 2)
create_rule("potentially bad keyword in {}", r"(?is)(?:^|\b|(?w:\b))(?-i:SEO|seo)$",
            title=False, body=False, username=True,
            max_rep=30, max_score=1)
