...
class FindSpam:
    ...
    rules = [
        ...
        {'method': non_english_link, 'all': True, 'sites': [], 'reason': 'Non-English link in {}', 'title': False, 'body': True, 'username': False, 'stripcodeblocks': True, 'body_summary': False, 'questions': False, 'max_rep': 1},
