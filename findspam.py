...
class FindSpam:
    ...
    rules = [
        ...
        {'regex': u"</a></p>$", 'all': False, 'sites': ["drupal.stackexchange.com"], 'reason': 'Link at end of {}', 'title': False, 'body': True, 'username': False, 'stripcodeblocks': False, 'body_summary': False, 'answers': False},
