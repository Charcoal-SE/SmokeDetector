...
class FindSpam:
    ...
    blacklisted_websites = ["online ?kelas", "careyourhealths", "wowtoes",
                            ...
                            "liveestorebuilder\\.com", "exampracticequestions\\.com"]
    ...
    rules = [
        ...
        {'regex': ur"(?i)virility|diet ?(plan|pill)|\b(pro)?derma[a-su-z]\w|(fat|\bweight)[ -]?(loo?s[es]|reduction)|loo?s[es] ?weight|\bherpes\b", 'all': True,
