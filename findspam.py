...
class FindSpam:
    ...
    pattern_websites = [r"health\d{3,}", r"http\S*?\.repair\W", r"filefix(er)?\.com", "\.page\.tl\W",
                        ...
                        r"(medical|health|beauty|rx|skin|slim|weight|fat|shred)[\w-]*?(info|try|idea|pro|tip|review|critique|blog|guide|advi[sc]|discussion|solution|consult)[\w-]*\.(co|net|org|in\W|info)",
