...
class FindSpam:
    rules = [
     ...
     {'regex': u"(?i)(orabank|powerigfaustralia|cfpchampionship2015playofflive|optimalstackfacts\.org|maletestosteronebooster\.org|x4facts\.com|tripleeffectseyeserum\.org|healthcaresup\.com|garciniacambogiaprofacts\.com|filerepairforum\.com)", 'sites': [], 'all': True, 'reason': "Blacklisted website", 'title': True, 'body': True, 'username': True},
