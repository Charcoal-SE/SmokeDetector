...
class FindSpam:
    ...
    rules = [
        ...
        {'regex': u"(?i)\\p{Script=Han}", 'all': True,
        ...
        {'regex': u"(?i)\\b(nigg(a|er)|asshole|fag|fuck(ing?)?|shit(t?er|hole)|whore|cunt)s?\\b", 'all': True,
        ...
        {'regex': u"https?://(?!(www\\.)?example\\.(com|net|org))[a-zA-Z0-9_.-]+\\.[a-zA-Z]{2,4}", 'all': True,
        ...
        {'regex': u"^https?://(?!(www\\.)?example\\.(com|net|org))[a-zA-Z0-9_.-]+\\.[a-zA-Z]{2,4}(/\\S*)?$", 'all': False,
        ...
        {'regex': u"//[A-Za-z0-9-\.]*/?[A-Za-z0-9-]*/?</a>(?:</strong>)?\s*</p>\s*$", 'all': False, 'sites': ["superuser.com", "drupal.stackexchange.com", "meta.stackexchange.com"], 'reason': 'Link at end of {}', 'title': False, 'body': True, 'username': False, 'stripcodeblocks': False, 'body_summary': False, 'answers': False},
