...
class FindSpam:
    bad_keywords = ["baba ?ji", "fifa.*coins?", "fifabay", "Long Path Tool",
                    ...
                    "smartican", "essay writing service", "T-complex"]
    ...
    pattern_websites = [r"health\d{3,}", r"http\S*?\.repair\W", r"filefix(er)?\.com", "\.page\.tl\W",
                        ...
                        r"(derma|medical|medicare|health|beauty|rx|skin|slim|weight|fat|nutrition|shred|alpha|brain(?!tree))[\w-]*?(help|info|program|try|idea|pro|tip|review|assess|report|critique|blog|guide|advi[sc]|discussion|solution|consult|source|sups|vms|cream)[\w-]*?\.(co|net|org|in\W|info)",
