...
class FindSpam:
    ...
    rules = [
        ...
        {'regex': u"(?i)(erica|jeff|er1ca|spam)", 'all': False, 'sites': ["parenting.stackexchange.com"], 'reason': "Bad keyword in {}", 'title': False, 'body': True, 'username': False, 'stripcodeblocks': False, 'body_summary': True}
    ]
