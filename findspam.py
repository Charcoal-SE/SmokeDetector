...
def religion_troll(s, site):
    regexes = [
        ...
        r'|slut+(?:ish|y)?|harlot|whore|bloody|rotten|diseased|swelling|lesbian|queer|(?:homo|trans|bi)(?:sexual)?|tran+y|'
        ...
        r'|bloody|rotten|diseased|swelling|lesbian|queer|(?:homo|trans|bi)(?:sexual)?|tran+y|retard|jew(?:ish)?|nig+er|nic+a|'
        ...
        r'(?:g?[eio]t)?s?|tran+y|morons?|(circumcised\W*)?bastards?|jhandus?|(?:mother\W*?)?fuck(?:s|ing|ers)?|sucks?|'
