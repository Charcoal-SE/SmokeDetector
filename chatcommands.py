...
def reject(msg, args, alias_used="reject"):
    ...
    # Forward this, because checks are better placed in gitmanager.py
    rejected_image="https://camo.githubusercontent.com/77d8d14b9016e415d36453f27ccbe06d47ef5ae2/68747470733a2f2f726173746"
        "5722e736869656c64732e696f2f62616467652f626c61636b6c6973746572732d72656a65637465642d7265642e706e67"
    try:
        message_url = "https://chat.{}/transcript/{}?m={}".format(msg._client.host, msg.room.id, msg.id)
        chat_user_profile_link = "https://chat.{}/users/{}".format(
            msg._client.host, msg.owner.id)
